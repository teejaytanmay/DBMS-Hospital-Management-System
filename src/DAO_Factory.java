...
public class DAO_Factory
{
	...
	static final String USER = "teejay";
	...
	TreatmentDAO treatmentDAO = null;
	DiagnosticLabDAO dLabDAO = null;
  DiagnosticLabVisitDAO dLabVisitDAO = null;
	...
	public DiagnosticLabDAO getDiagnosticLabDAO() throws Exception
	{
		...
		if( dLabDAO == null )
		{
		    dLabDAO = new DiagnosticLabDAO_JDBC( dbconnection );
		}
		return dLabDAO;
	}
	...
	public DiagnosticLabVisitDAO getDiagnosticLabVisitDAO() throws Exception
	{
		if( activeConnection == false )
		{
			throw new Exception("Connection not activated...");
		}
		if( dLabVisitDAO == null )
		{
			dLabVisitDAO = new DiagnosticLabVisitDAO_JDBC( dbconnection );
		}
		return dLabVisitDAO;
	}
  public TreatmentDAO getTreatmentDAO() throws Exception
	{
		if( activeConnection == false )
		{
			throw new Exception("Connection not activated...");
		...
		{
			treatmentDAO = new TreatmentDAO_JDBC( dbconnection );
		}
		return treatmentDAO;
	}
